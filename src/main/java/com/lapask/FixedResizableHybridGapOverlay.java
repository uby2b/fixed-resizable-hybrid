...
public class FixedResizableHybridGapOverlay extends Overlay
{
    ...
    @Inject
    public FixedResizableHybridGapOverlay(Client client, FixedResizableHybridConfig config, FixedResizableHybridPlugin plugin)
    {
        this.client = client;
        this.config = config;
        this.plugin = plugin;
